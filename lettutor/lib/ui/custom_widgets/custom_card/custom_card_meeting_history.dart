...
class CustomCardMeetingHistory extends StatefulWidget {
  final double width;
  final void Function() onPressedRecordButton;
  final void Function() onPressedReviewButton;
  ...
  const CustomCardMeetingHistory(
      {Key? key,
        required this.width,
        required this.onPressedRecordButton,
        required this.onPressedReviewButton,
  ...
  @override
  State<CustomCardMeetingHistory> createState() => _CustomCardMeetingHistoryState();
}

class _CustomCardMeetingHistoryState extends State<CustomCardMeetingHistory> {
